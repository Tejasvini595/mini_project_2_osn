...
main(int argc, char *argv[])
{
  ...
  1e:	96650513          	addi	a0,a0,-1690 # 980 <malloc+0x100>
  22:	7a6000ef          	jal	7c8 <printf>
  ...
  2c:	00001a97          	auipc	s5,0x1
  30:	99ca8a93          	addi	s5,s5,-1636 # 9c8 <malloc+0x148>
        
        // Small delay to see logs clearly
        if(i > 0 && i % 10 == 0) {
  34:	66666937          	lui	s2,0x66666
  38:	66790913          	addi	s2,s2,1639 # 66666667 <base+0x66665657>
    for(i = 0; i < pages; i++){
  3c:	06400b13          	li	s6,100
            printf("--- Allocated %d pages so far ---\n", i);
  40:	00001b97          	auipc	s7,0x1
  44:	9b8b8b93          	addi	s7,s7,-1608 # 9f8 <malloc+0x178>
  48:	a831                	j	64 <main+0x64>
            printf("sbrk failed at page %d\n", i);
  4a:	85a6                	mv	a1,s1
  4c:	00001517          	auipc	a0,0x1
  50:	96450513          	addi	a0,a0,-1692 # 9b0 <malloc+0x130>
  54:	774000ef          	jal	7c8 <printf>
            exit(1);
  58:	4505                	li	a0,1
  5a:	318000ef          	jal	372 <exit>
    for(i = 0; i < pages; i++){
  5e:	2485                	addiw	s1,s1,1
  60:	05648363          	beq	s1,s6,a6 <main+0xa6>
        p = sbrk(4096);   // grow by 1 page
  64:	8552                	mv	a0,s4
  66:	2d8000ef          	jal	33e <sbrk>
  6a:	862a                	mv	a2,a0
        if(p == (char*)-1){
  6c:	fd350fe3          	beq	a0,s3,4a <main+0x4a>
        p[0] = i & 0xFF;  // Write some data to make it dirty
  70:	00950023          	sb	s1,0(a0)
        printf("Allocated and touched page %d at va=0x%p\n", i, p);
  74:	85a6                	mv	a1,s1
  76:	8556                	mv	a0,s5
  78:	750000ef          	jal	7c8 <printf>
        if(i > 0 && i % 10 == 0) {
  7c:	02905e63          	blez	s1,b8 <main+0xb8>
  80:	03248733          	mul	a4,s1,s2
  84:	9709                	srai	a4,a4,0x22
  86:	41f4d79b          	sraiw	a5,s1,0x1f
  8a:	9f1d                	subw	a4,a4,a5
  8c:	0027179b          	slliw	a5,a4,0x2
  90:	9fb9                	addw	a5,a5,a4
  92:	0017979b          	slliw	a5,a5,0x1
  96:	40f487bb          	subw	a5,s1,a5
  9a:	f3f1                	bnez	a5,5e <main+0x5e>
            printf("--- Allocated %d pages so far ---\n", i);
  9c:	85a6                	mv	a1,s1
  9e:	855e                	mv	a0,s7
  a0:	728000ef          	jal	7c8 <printf>
  a4:	bf6d                	j	5e <main+0x5e>
        }
    }

    printf("evicttest completed allocations\n");
  a6:	00001517          	auipc	a0,0x1
  aa:	97a50513          	addi	a0,a0,-1670 # a20 <malloc+0x1a0>
  ae:	71a000ef          	jal	7c8 <printf>
    exit(0);
  b2:	4501                	li	a0,0
  b4:	2be000ef          	jal	372 <exit>
    for(i = 0; i < pages; i++){
  b8:	2485                	addiw	s1,s1,1
  ba:	b76d                	j	64 <main+0x64>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 466:	5ee80813          	addi	a6,a6,1518 # a50 <digits>
 46a:	88ba                	mv	a7,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 68a:	3cab8b93          	addi	s7,s7,970 # a50 <digits>
 ...
 6e8:	36448493          	addi	s1,s1,868 # a48 <malloc+0x1c8>
        for(; *s; s++)
